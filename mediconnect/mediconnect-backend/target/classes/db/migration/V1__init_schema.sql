...
-- ============================================================
-- DOCTOR AVAILABILITY (SCHEDULE SLOTS)
-- ============================================================
...
CREATE INDEX idx_chat_messages_appt     ON chat_messages(appointment_id);
CREATE INDEX idx_notifications_user     ON notifications(user_id);
CREATE INDEX idx_reviews_doctor         ON reviews(doctor_id);
CREATE INDEX idx_doctor_profiles_spec   ON doctor_profiles(specialty_id);
